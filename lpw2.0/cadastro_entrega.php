...
<body>
  ...
  <form class="container form-group" method="POST" action="php/entrega/cadastrar_entrega.php"><!-- Início Formulário Entregas -->
    <div class="mt-2">
    ...
    <div class="mt-2">
      ...
      <textarea rows="5" cols="30" class="form-control" type="text" name="descricao" id="descricao"></textarea>
    </div>
