...
include "/opt/lampp/htdocs/motogo/bd/conexaoBD.php";
...
function inserirEntrega1($data, $horario)
{
	global $conexao;
	$prepara = $conexao->prepare("INSERT INTO entregas1 (dataEntrega, hora) VALUES (?, ?)");
	$prepara->bind_param("ss", $data, $horario);
	$prepara->execute();
}
